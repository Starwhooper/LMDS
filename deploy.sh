...
"install")
	...
	if (whiptail --title "Restart Required" --yesno "It is recommended that you restart your device now. Current User was added to the (docker) user group for this to take effect logout and log back in or reboot. Select yes to do so now" 20 78); then
		sudo reboot
	fi
	;;
